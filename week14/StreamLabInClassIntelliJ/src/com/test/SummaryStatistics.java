...
public class SummaryStatistics {
    ...
    public double companyStatsWithStreamAverage() {
        ...
        System.out.print("Company stats with stream average: ");
        System.out.print(companies.stream().mapToDouble(Company::getRevenue).average().orElse(0.0));
        System.out.println();
    ...
    public void personsStatsByGenderList(){
        System.out.print("Persons Stats By Gender List: ");
        Predicate<Employee> predicateM = p -> p.getGender() == Employee.Gender.MALE;
        Predicate<Employee> predicateF = p -> p.getGender() == Employee.Gender.FEMALE;
        System.out.print("Group MALE:");
        System.out.print(Employee.persons().stream().filter(predicateM).count() + " ");
        System.out.print("Group FEMALE:");
        System.out.print(Employee.persons().stream().filter(predicateF).count());
    }
